...
Data<-read_csv(here::here("content/posts/Weather/data/WeatherData_YOW.csv"), col_names=TRUE, skip=25) %>%
...
canal_data <- read_csv(here::here("content/posts/Weather/data/canal_dates.csv"))

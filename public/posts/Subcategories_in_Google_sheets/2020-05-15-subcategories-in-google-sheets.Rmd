...
When building my extensive google sheets budget program (insert link here!) one thing I needed to figure out was how to make one drop down list based on the contents of another drop down list in order to specify categories and subcategories.

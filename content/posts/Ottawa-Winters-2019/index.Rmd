...
Data<-read_csv(here::here("content/posts/Ottawa-Winters-2019/data/WeatherData_YOW.csv"), col_names=TRUE, skip=25) %>%
...
canal_data <- read_csv(here::here("content/posts/Ottawa-Winters-2019/data/canal_dates.csv"))
